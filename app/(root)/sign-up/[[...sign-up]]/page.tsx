...
const SignUp = () => {
	const handleGoogleSignUp = () => signIn.social({ provider: "google" });
	const handleGithubSignUp = () => signIn.social({ provider: "github" });

	return (
		<div className="flex flex-col items-center justify-center min-h-[calc(100vh-100px)] py-2">
			<Card className="w-full max-w-md border-0 sm:border sm:border-border sm:shadow-sm">
				...
				<CardContent className="grid gap-4">
					<Button
						variant="outline"
						className="w-full h-12 flex items-center justify-center gap-3 relative"
